...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control" name="user_gmail" id="user_gmail" aria-describedby="helpId" placeholder="Correo electrónico">
        </div>
        <div class="mb-3">
          <label for="user_password" class="form-label">Contraseña</label>
          <input type="password"
            class="form-control" name="user_password" id="user_password" aria-describedby="helpId" placeholder="Contraseña segura">
        </div>
        <div class="mb-3">
          <label for="user_name" class="form-label">Nombre</label>
          <input type="text"
            class="form-control" name="user_name" id="user_name" aria-describedby="helpId" placeholder="Nombre">
        </div>

        <div class="mb-3">
          <label for="user_age" class="form-label">Edad</label>
          <input type="numeric"
            class="form-control" name="user_age" id="user_age" aria-describedby="helpId" placeholder="Edad">
        </div>

        <div class="mb-3">
          <label for="user_weight" class="form-label">Peso (Kg)</label>
          <input type="numeric"
            class="form-control" name="user_weight" id="user_weight" aria-describedby="helpId" placeholder="Peso en kilogramos">
        </div>

        <div class="mb-3">
          <label for="user_height" class="form-label">Altura (Cm)</label>
          <input type="numeric"
            class="form-control" name="user_height" id="user_height" aria-describedby="helpId" placeholder="Altura en centímetros">
        </div>
