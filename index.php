...
#Importar servicios
$sentencia=$conexion->prepare("SELECT * FROM tb_symptom_record");
$sentencia->execute();
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <b><li class="nav-item"><a class="nav-link" href="/malariaapp#app">App</a></li></b>
                        <b><li class="nav-item"><a class="nav-link" href="/malariaapp#portfolio">Malaria</a></li></b>
                        </b>
                    <b>
                        <li class="nav-item"><a class="nav-link" href="./mapa.php">Mapa</a></li>
                    </b>
                        <b><li class="nav-item"><a class="nav-link" href="/malariaapp#team">Equipo</a></li></b>
                        <b><li class="nav-item"><a class="nav-link nav-login" href="./app"
                            ><?php 
        ...
        <section class="page-section" id="app">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Desarrollada con el fin de mitigar los efectos de la enfermedad a nivel país y en el mundo.</h3>
                </div>
            ...
            <br>
            <div class="text-center"><a class="btn btn-primary btn-xl text-uppercase header-btn" href="./app">Utilizar App</a></div>
        </section>
        <!-- Malaria-->
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">La tecnología es y será la herramienta que hace al humano capaz de avanzar hacia ese futuro que busca.</p></div>
                </div>
            </div>
        </section>
        <!-- Portfolio Modals-->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p>La salud pública ambiental, que se refiere a la intersección entre el medioambiente y la salud pública, aborda los factores ambientales que influyen en la salud humana, y que incluyen factores físicos, químicos y biológicos, y todos los comportamientos relacionados con estos.</p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p>Casi la mitad de la población mundial está expuesta a enfermar de paludismo. Se calcula que 247 millones de personas de 85 países contrajeron el paludismo en 2021. Ese mismo año, la enfermedad se cobró aproximadamente 619 000 vidas.</p>
                                    <button class="btn btn-primary btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
                                        <i class="fas fa-xmark me-1"></i>
                                        Cerrar Ventana
                                    </button>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p>Los problemas de salud que se pueden presentar como consecuencia de la malaria incluyen:
...
Intervenciones de control de vectores. El control de los vectores es el enfoque principal para prevenir el paludismo y reducir la transmisión. Dos formas de control anti vectorial son eficaces para las personas que viven en países con paludismo endémico: los mosquiteros tratados con insecticida y la fumigación de interiores con insecticidas de acción residual. Más información sobre el control de vectores.
Tratamientos quimiopreventivos y quimioprofilaxis. Aunque están diseñados para tratar a pacientes que ya han sido infectados, algunos medicamentos antipalúdicos también se pueden usar para prevenir la enfermedad. Más información sobre los tratamientos quimiopreventivos.
</p>
                                    <button class="btn btn-primary btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
                                        <i class="fas fa-xmark me-1"></i>
                                        Cerrar Ventana
